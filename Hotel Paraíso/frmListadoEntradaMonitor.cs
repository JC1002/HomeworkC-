...
namespace HBRS
{
	public partial class frmListadoEntradaMonitor
	{
		public frmListadoEntradaMonitor()
		{
			InitializeComponent();
...
#region Default Instance
		...
		private static frmListadoEntradaMonitor defaultInstance;
		
		public static frmListadoEntradaMonitor Default
		{
			get
			{
				if (defaultInstance == null)
				{
					defaultInstance = new frmListadoEntradaMonitor();
