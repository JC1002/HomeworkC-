...
namespace HBRS
{
	sealed class Modulo1
	{

        public static OleDbConnection con = new OleDbConnection("Provider=MICROSOFT.ACE.OLEDB.12.0; Data Source=|DataDirectory|/BDHotelParaiso.accdb");
